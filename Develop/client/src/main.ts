...
const renderCurrentWeather = (currentWeather: any): void => {
  ...
  const { temperature, humidity, windSpeed, description } = currentWeather;
...
const renderForecast = (forecast: any[]): void => {
  ...
  forecast.forEach(item => renderForecastCard(item));
};

const renderForecastCard = (forecastItem: any) => {
  const { temperature, humidity, windSpeed, description } = forecastItem;
